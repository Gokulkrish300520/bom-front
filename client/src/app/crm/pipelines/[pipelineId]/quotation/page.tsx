    ...
    <div className="min-h-screen p-6 bg-white">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex gap-3">
          <button onClick={() => router.push("/books/purchase/gst")} className="px-4 py-2 text-sm font-semibold text-white bg-green-600 rounded-md hover:bg-green-700">
            Purchase
          </button>
      ...
      <div className="overflow-x-auto border rounded shadow">
        <table className="w-full border-collapse">
          <thead className="text-green-800 bg-green-100">
            <tr>
              {["Date", "Company Name", "Department", "Source", "Priority", "Actions"].map(h => (
