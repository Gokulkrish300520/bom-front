...
export default function QuotationListPage() {
  ...
  const handleNavigateToEdit = () => {
      ...
      closeDialog();
      navigate(`/crm/pipelines/quotation/${itemToEdit.id}/edit`);
  };
              ...
              <tr key={item.id} className="border-b hover:bg-green-50">
                ...
                <td className="p-2 border">
                    <div className="flex flex-wrap items-center gap-2">
                        ...
                        <button onClick={() => navigate(`/crm/pipelines/quotation/${item.id}/view`)} className="px-2 py-1 text-xs text-white bg-blue-500 rounded hover:bg-blue-600">View</button>
                        <button onClick={() => navigate(`/crm/pipelines/quotation/${item.id}/edit`)} className="px-2 py-1 text-xs text-white bg-yellow-500 rounded hover:bg-yellow-600">Edit</button>
