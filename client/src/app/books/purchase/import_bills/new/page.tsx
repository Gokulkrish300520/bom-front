...
export default function NewImportBill() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSaving(true);
    try {
      const res = await fetchWithAuth("https://web-production-6baf3.up.railway.app/api/importbills/", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(payload),
      });
      if (res.ok) {
        toast.success("Import Bill Created!");
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 bg-white rounded-md shadow-md">
      <div><Breadcrumb/>
      <h1 className="text-3xl font-semibold text-green-700 mb-6">New Import Bill</h1>
    </div>
      <div className="mb-4">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-end space-x-6">
          <button
            type="button"
            onClick={() => router.push("/books/purchase/import_bills")}
