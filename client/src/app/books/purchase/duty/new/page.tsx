...
export default function NewDutyPage() {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    // Auto calculate Assessable Value, Total USD/INR
    ...
    // Auto calculate Total = Assessable + IGST + Social Welfare + Chess + Duty + Add. Duty
  ...
  return (
    <div className="min-h-screen p-8 bg-white">
      <h1 className="mb-6 text-2xl font-bold text-green-700">Add New Duty</h1>
