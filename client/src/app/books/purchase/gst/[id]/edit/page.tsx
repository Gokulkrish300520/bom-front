...
export default function EditImportBillPage() {
    ...
    const fetchData = async () => {
      try {
        ...
        const [billRes, vendorRes, dealRes] = await Promise.all([
          fetchWithAuth(`https://web-production-6baf3.up.railway.app/api/gsts/${params.id}/`),
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetchWithAuth(
        `https://web-production-6baf3.up.railway.app/api/gsts/${bill.id}/`,
        {
          method: "PUT",
  ...
  return (
    <div className="min-h-screen p-6 bg-green-50">
      ...
      <h1 className="mb-6 text-2xl font-bold text-green-900">Edit Gst Bill</h1>
